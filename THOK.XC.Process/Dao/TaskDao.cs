...
namespace THOK.XC.Process.Dao
{
    public  class TaskDao : BaseDao
    {
        ...
        public DataTable TaskCraneDetail(string strWhere)
        {
            ...
            if (strWhere.Trim() == "")
                where = "1=1";
            string strSQL = "SELECT TASK.TASK_ID,TASK_NO,DETAIL.ITEM_NO,ASSIGNMENT_ID,DETAIL.CRANE_NO, '30'||TASK.CELL_CODE||'01' AS FROM_STATION,SYS_STATION.CRANE_POSITION TO_STATION  ,'0' AS STATE,TASK.BILL_NO," +
